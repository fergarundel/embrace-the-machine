...
function draw() {
  ...
  let dynamicSize = constrain(map(splitString.length,1,11,width*0.277778,width*0.083333),width*0.11,width*0.277778);
  ...
  // p.style('font-size' ,(windowWidth/windowHeight)*150+'px');
